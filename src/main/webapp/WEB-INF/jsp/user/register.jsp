...
&lt;%&ndash;    Powtórz hasło:<form:input path="password" type="password"/><br>&ndash;%&gt;
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form:form class="user" method="post" modelAttribute="user" action ="/register">
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <form:input path="firstName" type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Podaj imię "/>
                            ...
                            <div class="form-group">
                                <form:input path="email" type="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Email"/>
                            ...
                            <input type="submit" value="Załóż konto" class="btn btn-primary btn-user btn-block">
